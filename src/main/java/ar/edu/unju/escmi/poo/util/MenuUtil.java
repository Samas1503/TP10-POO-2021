                ...
                case 3:
                    ...
                    try {
                        do {
                            ...
                            nombre = sc.nextLine();
                            if (SalonUtil.verificarSalon(nombre)) { // se muestra la cantidad de mesas libres
                                Salon buscado = SalonUtil.obtenerSalon(nombre);
                                System.out.println(
                                        "El salon dispone de " + SalonUtil.obtenerMesasLibres(buscado) + " mesas");
                                r = "";
                ...
                case 4:
                    ...
                    try {
                        do {
                            ...
                            System.out.println("Ingrese el nombre del salon al que desea consultar.");
                            nombre = sc.nextLine();
                            if (SalonUtil.verificarSalon(nombre)) // mostramos las mesas ocupadas y la cantidad de
                                                                  // comensales
                            {
                ...
                case 5:
                    ...
                    try {
                        ...
                        // en caso de no tener registrado al cliente se registra al momento
                        {
                            ...
                            Cliente cliente = ClienteUtil.generarNuevoCliente(id);
                            ReservaUtil.generarReserva(cliente);
                        }
                    }
                    System.out.println("Se registro la reserva exitosamente!");
                    break;
                case 6:
                    // verificamos que haya datos cargados
                    ...
                    break;
                case 7:
                    if (ClienteUtil.obtenerClientes().isEmpty()) {
