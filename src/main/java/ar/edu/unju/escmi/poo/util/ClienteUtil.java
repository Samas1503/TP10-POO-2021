...
public class ClienteUtil {
    ...
    public static void precargarClientes() {
        crearClienteParticular(1, "Mayko Hernandez", "hola@mundo.com", 123);
        crearClienteParticular(2, "Samoel Panfila", "hola2@mundo.com", 432);
        crearClienteParticular(3, "Churro Chorolque", "hola3@mundo.com", 623);
        crearClienteParticular(4, "Santula Ancalay", "hola4@mundo.com", 765);
    ...
    public static Cliente generarNuevoCliente(int id) {
        Cliente cliente = null;
        ...
        System.out.println("Ingrese el Nombre del cliente " + r + ":");
        nombre = sc.nextLine();
        System.out.println("Ingrese el Email del cliente" + r + ":");
        email = sc.nextLine();
        System.out.println("Ingrese el Telefono del cliente" + r + ":");
        telefono = sc.nextInt();
